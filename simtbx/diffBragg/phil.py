...
merge_friedel = False
  .type = bool
  .help = "if True, F+ and F- are forced to share the same ASU index (non-anomalous mode); useful for native datasets with no anomalous signal"
  .expert_level = 10
