...
parser.add_argument("--exp", type=str, default="exp_name", help="column name for input expeirments (default is exp_name)")
parser.add_argument("--expIdx", type=str, default="exp_idx", help="column name for input expeirments (default is exp_idx)")
parser.add_argument("--refl", type=str, default="predictions", help="column name for refls (default is predictions)")
...
if __name__ == "__main__":
    ...
    modelers = load_inputs(df, params, exper_key=args.exp, refls_key=args.refl,
                           exper_idx_key= args.expIdx, gather_dir=gather_dir)
